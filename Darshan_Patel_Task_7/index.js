...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const draggableDiv1 = new DraggableDiv(backgroundDiv);
  const draggableDiv2 = new DraggableDiv(backgroundDiv);
  const draggableDiv3 = new DraggableDiv2(backgroundDiv);
});
