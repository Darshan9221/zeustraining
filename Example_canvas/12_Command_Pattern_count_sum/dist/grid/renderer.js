export class Renderer {
    ...
    drawGrid() {
        ...
        ctx.textBaseline = "middle";
        // Row numbers
        for (let r = this.model.viewportStartRow; r <= this.model.viewportEndRow + 1 && r < this.model.rows; r++) {
            const screenY = this.calculator.getRowY(r) - this.model.scrollY;
        ...
        // Column letters
        for (let c = this.model.viewportStartCol; c <= this.model.viewportEndCol + 1 && c < this.model.cols; c++) {
            const screenX = this.calculator.getColX(c) - this.model.scrollX;
