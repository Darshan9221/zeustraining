...
class App {
    constructor() {
        ...
        this.contextMenu = new ContextMenu(this.grid, this.historyManager);
        // Initialization
    ...
    setupEventListeners() {
        ...
        this.grid.canvas.addEventListener("contextmenu", (e) => this.handleContextMenu(e));
    ...
    handleContextMenu(e) {
        ...
        const isColHeader = y < this.grid.headerHeight && x > this.grid.headerWidth;
        const isRowHeader = x < this.grid.headerWidth && y > this.grid.headerHeight;
        const virtualX = x + this.grid.scrollX;
        const virtualY = y + this.grid.scrollY;
        let col = isColHeader ? this.grid.colAtX(virtualX) : null;
        let row = isRowHeader ? this.grid.rowAtY(virtualY) : null;
        this.contextMenu.show(e.clientX, e.clientY, row, col);
    }
