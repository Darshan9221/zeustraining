import { ResizeRowCommand } from "../history/commands";
export class RowResize {
    ...
    handleMouseUp(e) {
        ...
        const newHeight = this.grid.rowHeights[this.resizingRow];
        if (newHeight !== this.resizeOriginalHeight) {
            const command = new ResizeRowCommand(this.resizingRow, this.resizeOriginalHeight, newHeight);
